...
pub async fn run(ctx: Context, command: CommandInteraction) {
    ...
    let modal = CreateModal::new("goal", "Entregar Meta")
        .components(vec![value_i_component, who_i_component]);
...
pub fn register() -> CreateCommand {
    CreateCommand::new("meta").description("Envie infos sobre a meta")
}
